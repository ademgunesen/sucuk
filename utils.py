...
def get_preprocessing(preprocessing_fn,resolution):
...
def calculate_metrics(gt_folder, pred_folder,threshold=0.5):
    ...
    return iou, accuracy, recall, precision, fscore
...
def initialize_crop_save(crop_size,stride):

    crop_save_mask_images("images/train/image","images/train/cropped_image",crop_size,stride)
    crop_save_mask_images("images/test/image","images/test/cropped_image",crop_size,stride)
    #crop_save_mask_images("images/val/image","images/val/cropped_image",crop_size,stride)
    crop_save_mask_images("images/train/mask/ma","images/train/mask/cropped_ma",crop_size,stride)
    crop_save_mask_images("images/train/mask/ex","images/train/mask/cropped_ex",crop_size,stride)
    crop_save_mask_images("images/train/mask/se","images/train/mask/cropped_se",crop_size,stride)
    crop_save_mask_images("images/train/mask/he","images/train/mask/cropped_he",crop_size,stride)
    #crop_save_mask_images("images/val/mask/ma","images/val/mask/cropped_ma",crop_size,stride)
    #crop_save_mask_images("images/val/mask/ex","images/val/mask/cropped_ex",crop_size,stride)
    #crop_save_mask_images("images/val/mask/se","images/val/mask/cropped_se",crop_size,stride)
    #crop_save_mask_images("images/val/mask/he","images/val/mask/cropped_he",crop_size,stride)
    crop_save_mask_images("images/test/mask/ma","images/test/mask/cropped_ma",crop_size,stride)
    crop_save_mask_images("images/test/mask/ex","images/test/mask/cropped_ex",crop_size,stride)
    crop_save_mask_images("images/test/mask/se","images/test/mask/cropped_se",crop_size,stride)
    crop_save_mask_images("images/test/mask/he","images/test/mask/cropped_he",crop_size,stride)
...
def delete_black_masks(image_folder, mask_folder):
    ...
    for image_file, mask_file in file_pairs:
        ...
        if not any(mask_image.getdata()):
            # Delete the corresponding image and mask
            os.remove(image_path)
            os.remove(mask_path)
